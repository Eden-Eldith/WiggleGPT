"""
Optimized Training script for WiggleGPT with modern training techniques
=======================================================================

New optimizations over train_bio.py:
...
Preserves all core WiggleGPT functionality and bio-neuron features.
"""
...
from model_bio_optimized import GPTConfig, GPT
...
if use_bio_mlp:
    ...
    print(f"  Features: Oscillating activations, event sparsity")
else:
...
model_args = dict(
    ...
    use_bio_mlp=use_bio_mlp, bio_threshold=bio_threshold,
...
if init_from == 'scratch':
    ...
    for k in ['use_bio_mlp', 'bio_threshold', 'use_rmsnorm', 'use_rope', 'gradient_checkpointing']:
